	...
	<view class="list">
		...
		<view class="item">
			...
			<view class="item_left">
				...
				<view>
					<view class="title">特色烤鱼</view>
					<view class="tongji">
						<text>月售 100</text>
						<text>点赞 100</text>
					</view>
					<view class="time">备货时间 20 钟</view>
					<view class="price">￥18.0</view>
				</view>
			</view>
			<!-- 右边 -->
		...
		<view class="item">
			<!-- 左 -->
			<view class="item_left">
				<navigator url="../detail/detail?id=2">
					<image src="../../static/upload/list2.jpg"></image>
				</navigator>
				<view>
					<view class="title">茄子豆角</view>
					<view class="tongji">
						<text>月售 100</text>
						<text>点赞 100</text>
					</view>
			...
			<!--  跳转到菜单页面，加 open-type="switchTab"-->
			<!-- <navigator url="../cart/cart" open-type="switchTab"> -->
			<navigator url="../detail/detail?id=2" open-type="navigate">
				<image class="item_right" src="../../static/add_pro.png" mode=""></image>
			</navigator>
		</view>
		<!-- 1个产品 end-->
		...
		<view class="item">
			<!-- 左 -->
			<view class="item_left">
				<navigator url="../detail/detail?id=3">
					<image src="../../static/upload/list3.jpg"></image>
				</navigator>
				<view>
					<view class="title">手撕包菜</view>
					<view class="tongji">
						<text>月售 100</text>
						<text>点赞 100</text>
					</view>
			...
			<!--  跳转到菜单页面，加 open-type="switchTab"-->
			<!-- <navigator url="../cart/cart" open-type="switchTab"> -->
			<navigator url="../detail/detail?id=3" open-type="navigate">
				<image class="item_right" src="../../static/add_pro.png" mode=""></image>
			</navigator>
		</view>
		<!-- 1个产品 end-->
		...
		<view class="item">
			...
			<!--  跳转到菜单页面，加 open-type="switchTab"-->
			<!-- <navigator url="../cart/cart" open-type="switchTab"> -->
			<navigator url="../detail/detail?id=4" open-type="navigate">
				<image class="item_right" src="../../static/add_pro.png" mode=""></image>
			</navigator>
		</view>
		<!-- 1个产品 end-->
		...
		<view class="item">
			<!-- 左 -->
			<view class="item_left">
				<navigator url="../detail/detail?id=5">
					<image src="../../static/upload/list5.jpg"></image>
				</navigator>
				<view>
					<view class="title">红烧武昌鱼</view>
					<view class="tongji">
						<text>月售 100</text>
						<text>点赞 100</text>
					</view>
			...
			<!--  跳转到菜单页面，加 open-type="switchTab"-->
			<!-- <navigator url="../cart/cart" open-type="switchTab"> -->
			<navigator url="../detail/detail?id=5" open-type="navigate">
				<image class="item_right" src="../../static/add_pro.png" mode=""></image>
			</navigator>
		</view>
		<!-- 1个产品 end-->
		...
		<view class="item">
			<!-- 左 -->
			<view class="item_left">
				<navigator url="../detail/detail?id=6">
					<image src="../../static/upload/list6.jpg"></image>
				</navigator>
				<view>
					<view class="title">糍粑鱼</view>
					<view class="tongji">
						<text>月售 100</text>
						<text>点赞 100</text>
					</view>
			...
			<!--  跳转到菜单页面，加 open-type="switchTab"-->
			<!-- <navigator url="../cart/cart" open-type="switchTab"> -->
			<navigator url="../detail/detail?id=6" open-type="navigate">
				<image class="item_right" src="../../static/add_pro.png" mode=""></image>
			</navigator>
		</view>
		<!-- 1个产品 end-->
